...
# First 2D example of city flow:
Compresible Navier-Stokes (low Mach).
SGS model: Richardson-corrected Smagorinsky. 
Effective (average) resolution: approx Dx = Dy = Dz = 25 m using 4th-order spectral elements.
Periodic b.c.
Simulated using [Jexpresso](https://github.com/smarras79/Jexpresso/tree/sm/newmaster)

![LES6](/assets/videos/city2d_uv.gif)
